...
bool aruco_interface__msg__aruco_markers__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("aruco_interface.msg._aruco_markers.ArucoMarkers", full_classname_dest, 47) == 0);
  }
  aruco_interface__msg__ArucoMarkers * ros_message = _ros_message;
  {  // header
...
PyObject * aruco_interface__msg__aruco_markers__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("aruco_interface.msg._aruco_markers");
