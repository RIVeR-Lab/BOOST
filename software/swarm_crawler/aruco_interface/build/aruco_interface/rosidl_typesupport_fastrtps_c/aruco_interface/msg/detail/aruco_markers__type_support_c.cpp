...
#include "aruco_interface/msg/detail/aruco_markers__rosidl_typesupport_fastrtps_c.h"
...
using _ArucoMarkers__ros_msg_type = aruco_interface__msg__ArucoMarkers;
...
size_t get_serialized_size_aruco_interface__msg__ArucoMarkers(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ArucoMarkers__ros_msg_type * ros_message = static_cast<const _ArucoMarkers__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _ArucoMarkers__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_aruco_interface__msg__ArucoMarkers(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_aruco_interface
size_t max_serialized_size_aruco_interface__msg__ArucoMarkers(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_aruco_interface__msg__ArucoMarkers(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, aruco_interface, msg, ArucoMarkers)() {
