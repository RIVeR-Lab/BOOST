...
static const _ArucoMarkers_type_support_symbol_names_t _ArucoMarkers_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, aruco_interface, msg, ArucoMarkers)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, aruco_interface, msg, ArucoMarkers)),
  }
};
...
{
  return &::aruco_interface::msg::rosidl_typesupport_cpp::ArucoMarkers_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, aruco_interface, msg, ArucoMarkers)() {
  return get_message_type_support_handle<aruco_interface::msg::ArucoMarkers>();
}
